...
def main(args):
    ...
    dataset_infos.compute_input_output_dims(
        ...
        retrieval_token_meta_dim=getattr(args, "retrieval_token_meta_dim", 1),
    ...
    if args.model == 'RetroBridge':
        model = MarkovBridge(
            ...
            augmented_graphfeature=args.augmented_graphfeature,
            retrieval_token_meta_dim=getattr(args, "retrieval_token_meta_dim", 1),
            rxn_class_num=getattr(args, "rxn_class_num", 0),
            rxn_class_loss_weight=getattr(args, "rxn_class_loss_weight", 0.0),
            rxn_class_offset=getattr(args, "rxn_class_offset", 0),
        )
